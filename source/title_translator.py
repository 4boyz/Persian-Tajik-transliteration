...
def persian_title_parser(soup: BeautifulSoup):
    ...
    if(title == None):
        title = soup.find("span", id_="promo-persianworld201408140820_u08_netanyahu_vows_campaign_cont-1")
...
if __name__ == "__main__":
    ...
    TAJIK_DUMPS_DIRECTORY = DATA_DIRECTORY + "\\tajik_dump"
    ...
    PERSIAN_DUMPS_DIRECTORY = DATA_DIRECTORY + "\\persian_dump"
